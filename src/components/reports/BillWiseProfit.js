...
export default function BillWiseProfit({ data, setData }) {
  const [arg, setArg] = useState();
  const columns = [
    { key: "invoice_date", label: "Invoice Date",type:"string" },
    { key: "invoice_number", label: "Invoice Number",type:"number"  },
    { key: "name", label: "Party",type:"string" },
    { key: "totalSales", label: "Total Sale Amount",type:"number"  },
