...
export default function StockDetails({ data, setData }) {
  const [arg, setArg] = useState();
  const columns = [
    { key: "index", label: "#",type:"number"  },
    { key: "Name", label: "Item Name",type:"string" },
    { key: "stock", label: "Begining Quantity",type:"number"  },
    { key: "moneyInn", label: "Quantity In",type:"number"  },
    { key: "moneyInn", label: "Purchase Amount" ,type:"number" },
    { key: "moneyInn", label: "Quantity Out" ,type:"number" },
    { key: "moneyInn", label: "Sale Amount" ,type:"number" },
    { key: "stock", label: "Closing Quantity" ,type:"number" },
    // { key: "DropDown", label: "-" },
  ];
