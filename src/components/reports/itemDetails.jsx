...
export default function ItemDetailsReport({ data, setData }) {
  const [arg, setArg] = useState();
  const columns = [
    { key: "index", label: "#",type:"number"  },
    { key: "invoice_date", label: "Date",type:"string" },
    { key: "stock", label: "Sale Quantity",type:"number"  },
    { key: "moneyInn", label: "Adjustment Quantity",type:"number"  },
    { key: "moneyInn", label: "Closing Quantity",type:"number"  },
    // { key: "DropDown", label: "-" },
  ];
