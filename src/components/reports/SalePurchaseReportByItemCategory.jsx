...
export default function SalePurchaseReportByItemCategory({ data, setData }) {
  const [arg, setArg] = useState();
  const columns = [
    { key: "Name", label: "Item Categor" ,type:"string"},
    { key: "moneyInn", label: "Sale Quantity" ,type:"number" },
    { key: "moneyInn", label: "Total Sale Amount",type:"number"  },
    { key: "moneyInn", label: "Purchase Quantity" ,type:"number" },
    { key: "moneyInn", label: "Total Purchase Amount" ,type:"number" },
    { key: "moneyInn", label: "Total Purchase Amount",type:"number"  },
    // { key: "DropDown", label: "-" },
  ];
