...
export default function ManifacturingReports({ data, setData }) {
  const [arg, setArg] = useState();
  const columns = [
    { key: "index", label: "#",type:"number"  },
    { key: "invoice_date", label: "Item Name",type:"string" },
    { key: "Dt", label: "Date",type:"string" },
    { key: "Dt", label: "Qty Manifacture" ,type:"number" },
    { key: "Dt", label: "Amount",type:"number"  },
    { key: "Dt", label: "Details",type:"number"  },
    // { key: "DropDown", label: "-" },
  ];
