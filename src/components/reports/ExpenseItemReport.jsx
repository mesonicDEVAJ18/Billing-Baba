...
export default function ExpenseItemReports({ data, setData }) {
  const [arg, setArg] = useState();
  const columns = [
    { key: "index", label: "#",type:"number"  },
    { key: "invoice_date", label: "Expense Name",type:"string" },
    { key: "Dt", label: "Unit Price",type:"number"  },
    { key: "Dt", label: "Qty",type:"number"  },
