...
export default function ItemBatchRep({ data, setData }) {
  const [arg, setArg] = useState();
  const columns = [
    { key: "index", label: "Invoice Date",type:"string" },
    { key: "Name", label: "Item Name",type:"string" },
    { key: "salesPrice", label: "MRP",type:"number"  },
    { key: "batchNo", label: "Batch No.",type:"number"  },
    { key: "model", label: "Model No.",type:"number"  },
    { key: "mfgDate", label: "Mfg Date",type:"number"  },
    { key: "expDate", label: "Exp Date",type:"number"  },
    { key: "size", label: "Size",type:"number"  },
    { key: "stock", label: "Current Quantity",type:"number"  },
  ];
  const sendingArray = data?.items
    ...
    .map((ele, index) => {
      return {
        ...
        stock: ele.stock ? ele.stock : "no opening stock",
