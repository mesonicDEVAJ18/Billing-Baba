  ...
  return (
    <div id="saleInvoice">
      ...
      {data && (
        ...
        //     </div>
        //     <button onClick={() => Navigate("/add-purchase-return")}>
        //       + Add Debit Note
        //     </button>
        //   </div>
        //   <div className="cl">
        ...
        //     (sale) => sale.type === "Purchase Return"
        //   )?.map((sale, index) => (
        ...
        // </div>
          <div className="">
                <div className="flex justify-between p-4 rounded-md bg-gray-100 items-center">
                  ...
                  <button className="px-2 py-1 rounded-full font-semibold text-white bg-blue-500 ml-2"  onClick={() => Navigate("/add-purchase-return")}>
              + Add Debit Note
            </button>
                </div>
