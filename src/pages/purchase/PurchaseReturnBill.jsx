...
const PurchaseReturnBill = ({ data, setData, change, setChange }) => {
  ...
  return (
    <div className="p-8">
      ...
      >
        {/* Header */}
        <div className="flex justify-between mb-8 border-b-2 border-purple-600">
          <div>
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-purple-600">Debit Note</h2>
        </div>

        {/* Order Details */}
        <div className="flex justify-between mb-8">
          <div>
            <h1 className="font-bold">Return Form</h1>
            <p>
          ...
          <div className="text-right">
            ...
            <p>
              <strong>Return No.:</strong> {pData.invoice_number}
            </p>
            <p>
              <strong>Date:</strong> {pData.date}
            </p>
            <p>
            ...
            <p>
              <strong>Invoice Date:</strong> {pData.invoice_date}
            </p>
          </div>
        </div>
